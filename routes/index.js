...
router.get('/', function (req, res) {
  res.render('index', { title: 'Chocolate App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Chocolate App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Chocolate App Login', user : req.user });
});
